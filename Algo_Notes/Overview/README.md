...
Phần tiền xử lý `tex/preamble.tex`, từng chương ở `chapter/`, hình ở `resource/img`, tài liệu tham khảo ở `refs/references.bib`, bìa riêng ở `tex/titlepage.tex`.
...
## Ghi chú
- Thay đổi tiêu đề/tác giả trong `tex/titlepage.tex`.
